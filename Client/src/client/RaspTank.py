...
def replace_num(initial,new_num):   #Call this function to replace data in '.txt' file
    newline=""
    str_num=str(new_num)
    with open("c:/Users/Sabatier/Documents/Dev/Perso/Client/ip.txt","r") as f:
...
def instruction():
    instructions = []
    while 1:
        instruction_1 = 'Vous pouvez utiliser les raccourcis pour controler le robot'
        instructions.append(instruction_1)
        instruction_2 = 'W: Avancer   S: Reculer   A: Tourner à Gauche   D: Tourner à droite'
        instructions.append(instruction_2)
        instruction_3 = 'I: Regarder en haut   K: Regarde en bas   J: Attraper   L: Lacher'
        ...
        instruction_5 = 'F(Bouton menu du  GUI): Les bras et la tête retournes à leur position initial'
        instructions.append(instruction_5)
        instruction_6 = 'Cela va mettre les servo moteur à 0'
        instructions.append(instruction_6)
        instruction_7 = 'Pour une meilleurs batterie et maintenance des servo moteur'
...
def socket_connect():     #Call this function to connect with the server
    ...
    for i in range (1,6): #Try 5 times if disconnected
        if ip_stu == 1:
            ...
            print("Impossible de se connecter au serveur,ressayer plus tard!")
...
def loop():                      #GUI
    ...
    while True:
        ...
        root.title('RaspTank')      #Main window title
        root.geometry('565x510')  #Main window size, middle of the English letter x.
        root.config(bg=color_bg)  #Set the background color of root window

        try:
            logo =tk.PhotoImage(file = 'logo1.png')         #Define the picture of logo,but only supports '.png' and '.gif'
            l_logo=tk.Label(root,image = logo,bg=color_bg) #Set a label to show the logo picture
            l_logo.place(x=25,y=14)                        #Place the Label in a right position
        except:
            pass
        ...
        l_ip_4=tk.Label(root,width=18,text='Deconnecté',fg=color_text,bg='#F44336')
        l_ip_4.place(x=400,y=110)                         #Define a Label and put it in position

        l_ip_5=tk.Label(root,width=18,text='Utiliser l ip par défaut',fg=color_text,bg=color_btn)
        ...
        Btn0 = tk.Button(root, width=8, text='Avancer',fg=color_text,bg=color_btn,relief='ridge')
        Btn1 = tk.Button(root, width=8, text='Reculer',fg=color_text,bg=color_btn,relief='ridge')
        Btn2 = tk.Button(root, width=8, text='Gauche',fg=color_text,bg=color_btn,relief='ridge')
        Btn3 = tk.Button(root, width=8, text='Droite',fg=color_text,bg=color_btn,relief='ridge')
        ...
        Btn_up = tk.Button(root, width=8, text='Haut',fg=color_text,bg=color_btn,relief='ridge')
        Btn_down = tk.Button(root, width=8, text='Bas',fg=color_text,bg=color_btn,relief='ridge')
        Btn_left = tk.Button(root, width=8, text='Attraper',fg=color_text,bg=color_btn,relief='ridge')
        Btn_right = tk.Button(root, width=8, text='Lacher',fg=color_text,bg=color_btn,relief='ridge')
        ...
        Btn14= tk.Button(root, width=8,height=2, text='Connecter',fg=color_text,bg=color_btn,command=connect_click,relief='ridge')
        ...
        Btn_FindColor = tk.Button(root, width=10, text='Trouver la couleur',fg=color_text,bg=color_btn,relief='ridge')
        ...
        Btn_Fun4 = tk.Button(root, width=10, text='Trouver la ligne',fg=color_text,bg=color_btn,relief='ridge')
